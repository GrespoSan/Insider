# Independent Insider Radar v0.10
...
## v0.10
Aggiunge analisi esplorativa FIRST_CLUSTER per controvalore e ruoli SEC, filtro combinato (n insider + valore + ruolo) e bootstrap issuer-level del segmento selezionato contro SOLO. Esclude i record value_review dalle tabelle per controvalore e segnala esplicitamente il rischio di data-mining.
