# Independent Insider Radar LIVE v1.3
...
## Novità v1.3 — Forward Registry
La v1.3 salva automaticamente ogni CORE/WATCH con contesto completo in `data/live_v1/forward_registry_v1_2.csv`.

Per evitare di chiamare *forward* ciò che era già noto prima della v1.3:
...
4. La sezione **Forward Registry — v1.3** si aggiorna automaticamente.
...
I vecchi backup v1.0/v1.1 restano importabili; se non contengono un registry, il primo avvio v1.3 crea una nuova BASELINE.
...
## Novità v1.3 — uso quotidiano

La v1.3 non cambia l'algoritmo. Migliora solo la leggibilità operativa:
