# Independent Insider Radar LIVE v1.3.1
...
Per evitare di chiamare *forward* ciò che era già noto prima della v1.3.1:
...
I vecchi backup v1.0/v1.1 restano importabili; se non contengono un registry, il primo avvio v1.3.1 crea una nuova BASELINE.
...
## Novità v1.3.1 — gerarchia visiva

La v1.3.1 non cambia l'algoritmo. Migliora solo la leggibilità operativa:
